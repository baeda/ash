...
public class ASTBaseVisitor<T, A> implements ASTVisitor<T, A> {
    ...
    @Override
    public T
    visitVarDeclAssignNode(VarDeclAssignNode node, A argument) {
        return visitChildren(node, argument);
    }
    ...
    @Override
    public T
    visitWhileLoopNode(WhileLoopNode node, A argument) {
        return visitChildren(node, argument);
    }
    ...
    @Override
    public T
    visitVarDeclAssignStatementNode(VarDeclAssignStatementNode node, A argument) {
        return visitChildren(node, argument);
    }
    ...
    @Override
    public T
    visitLtExpressionNode(LtExpressionNode node, A argument) {
        return visitChildren(node, argument);
    }

    @Override
    public T
    visitGtExpressionNode(GtExpressionNode node, A argument) {
        return visitChildren(node, argument);
    }

    @Override
    public T
    visitLtEqExpressionNode(LtEqExpressionNode node, A argument) {
        return visitChildren(node, argument);
    }

    @Override
    public T
    visitGtEqExpressionNode(GtEqExpressionNode node, A argument) {
        return visitChildren(node, argument);
    }
